-- Migration: Add is_deleted to orders table and update update_order_atomic
-- Purpose: 
--   1. Add is_deleted column to orders table.
--   2. Update update_order_atomic RPC function to support setting is_deleted.
