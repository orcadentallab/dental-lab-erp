-- Migration 087: Expand Order History Tracking Fields
-- Description: Update log_order_changes to log changes to cost, manual_cost, total_price, design_price, manual_design_price, discount, delivery_date, priority, and entity IDs.
