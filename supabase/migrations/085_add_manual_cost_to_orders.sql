-- =====================================================================
-- Migration 085: Track manual order cost separately
-- Date: 2026-05-11
-- Purpose: Keep orders.cost as the effective accounting cost while
-- preserving whether that value came from an admin manual override.
-- =====================================================================
