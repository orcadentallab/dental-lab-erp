-- Migration: Fix update_order_atomic RPC to support missing fields
-- Purpose: Include branch_name, shade, delivery_type, manual_design_price, production_status, and issue_state in the atomic update function.
