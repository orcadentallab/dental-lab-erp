-- Migration: Allow representatives to see all doctors and follow ups (same as admin)
-- Date: 2026-07-06
...
BEGIN
    ...
    doctor_metrics AS (
        ...
        WHERE 
            -- تم تعديل الشرط هنا ليسمح للمناديب برؤية كل البيانات مثل الأدمن
            (v_my_role IN ('admin', 'representative'))
...
BEGIN
    ...
    WHERE 
        ...
        -- تم تعديل الشرط هنا ليسمح للمناديب برؤية كل المتابعات
        AND (v_my_role IN ('admin', 'representative'));
END;
$$;
