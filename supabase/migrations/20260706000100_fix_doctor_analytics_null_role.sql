-- Migration: Fix null role check in get_doctors_activity_analytics
-- Date: 2026-07-06
...
BEGIN
    ...
    doctor_metrics AS (
        ...
        WHERE 
            -- تم إصلاح عزل المندوب ليعمل بشكل صحيح حتى لو كان دور المستخدم غير محدد (NULL) عند تشغيل الاستعلام من Postgres CLI
            (v_my_role IS NULL OR v_my_role != 'representative' OR d.representative_id = v_my_user_id)
