...
import {
    ...
    AlertTriangle, ChevronDown, Wrench
} from 'lucide-react';
    ...
    return (
        <>
            <div className="flex flex-wrap items-center gap-1.5">
                ...
                {/* The "ابدأ الإنتاج" button used to live here. It is gone
                    because the chain now builds itself: 20260827000000 puts a
                    trigger on the order that starts the case and keeps its
                    stages level with production_status. Leaving the button
                    would be a second way to do what already happened -- and on
                    a case older than the measurement cutoff it would build a
