    ...
    return (
        <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 bg-white p-1 rounded-2xl border border-slate-200 shadow-sm w-fit">
                    <button
                        ...
                        <table className="w-full text-right border-collapse">
                            <thead>
                                <tr className="bg-slate-50/80 border-b border-slate-100">
                                    ...
                                    <th className="px-6 py-5 text-sm font-extrabold text-slate-700 tracking-wide min-w-[100px]">التاريخ</th>
                                ...
                                {filteredOrders.map((order) => {
                                    ...
                                    return (
                                        <motion.tr
                                            ...
                                            animate={{ opacity: 1 }}
                                            key={order.id}
                                            className="hover:bg-cyan-50/40 transition-colors group border-b border-slate-50"
                                        >
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[9px] text-slate-300 font-mono mt-0.5">{order.id.split('-')[0]}</span>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-1.5 font-black text-slate-900 text-xs">
                                                    ...
                                                    {order.status === 'Rejected' && order.rejectedLabCost !== undefined && (
                                                        <div className="px-1.5 py-0.5 bg-amber-100 border border-amber-200 rounded text-[9px] text-amber-900 font-black">
                                                            {order.rejectedLabCost}
                                                        </div>
                                                    )}
                                                </div>
                                            </td>
