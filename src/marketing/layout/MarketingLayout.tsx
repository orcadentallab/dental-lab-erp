...
export default function MarketingLayout({ children }: MarketingLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-brand-offwhite font-sans text-brand-slate" dir="ltr">
            {/* <title>ORCA Lab</title> <meta name="description" content="Marketing page for ORCA Dental Lab" /> <meta property="og:title" content="ORCA Lab" /> */}
            {/* Header / Navbar */}
            <header
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        {/* Logo */}
                        <a data-nav href="#hero" className="flex items-center gap-3 group">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <a data-nav href="/login" className="text-sm font-bold text-brand-slate-light hover:text-brand-black transition-colors">
                                Portal Login
                            </a>
                            <a data-nav href="#contact" className="bg-brand-blue text-white px-5 py-2.5 rounded-full text-sm font-bold shadow-md shadow-brand-blue/30 hover:bg-brand-sky transition-colors duration-300 hover:shadow-lg">
                                Start a Case →
                            </a>
                        </div>
                ...
                >
                    <nav className="max-w-7xl mx-auto px-4 py-4 space-y-1">
                        ...
                        <div className="border-t border-gray-100 mt-3 pt-3 space-y-2">
                            <a data-nav href="tel:+201034141917" className="flex items-center gap-2 px-4 py-2.5 text-sm text-brand-slate-light hover:text-brand-blue transition-colors">
                                <Phone size={16} />
                                +20 103 414 1917
                            </a>
                            <a data-nav href="mailto:orcadentallab@gmail.com" className="flex items-center gap-2 px-4 py-2.5 text-sm text-brand-slate-light hover:text-brand-blue transition-colors">
                                <Mail size={16} />
                                orcadentallab@gmail.com
                            </a>
                        </div>
                        <div className="border-t border-gray-100 mt-3 pt-3 flex flex-col gap-2 px-4">
                            <a data-nav href="/login" className="text-sm font-bold text-brand-slate-light hover:text-brand-black transition-colors py-2">
                                Portal Login
                            </a>
                            <a data-nav href="#contact" onClick={() => setMobileMenuOpen(false)} className="bg-brand-blue text-white px-5 py-3 rounded-full text-sm font-bold text-center shadow-md shadow-brand-blue/30 hover:bg-brand-sky transition-colors">
                                Start a Case →
                            </a>
                        </div>
                    </nav>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                        ...
                        <div className="sm:col-span-2 lg:col-span-1 space-y-4">
                            ...
                            <div className="flex gap-3 pt-2">
                                <a data-nav href="https://www.facebook.com/orca.labeg" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full bg-brand-slate/40 flex items-center justify-center text-brand-slate-lighter hover:bg-brand-blue hover:text-white cursor-pointer transition-[color,background-color] duration-300">
                                    <Facebook size={18} />
                                </a>
                                <a data-nav href="https://www.instagram.com/orca.labeg/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-brand-slate/40 flex items-center justify-center text-brand-slate-lighter hover:bg-brand-blue hover:text-white cursor-pointer transition-[color,background-color] duration-300">
                                    <Instagram size={18} />
                                </a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm">
                                <li><a data-nav href="#services" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">Services</a></li>
                                <li><a data-nav href="#portfolio" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">Portfolio</a></li>
                                <li><a data-nav href="#pricing" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">Pricing</a></li>
                                <li><a data-nav href="#faq" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">FAQ</a></li>
                                <li><a data-nav href="#contact" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">Contact Us</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-sm">
                                <li>
                                    <a data-nav href="tel:+201034141917" className="flex items-start gap-3 group hover:text-white transition-colors duration-200">
                                        <Phone size={16} className="mt-0.5 shrink-0 text-brand-sky" />
                                        <span>+20 103 414 1917</span>
                                    </a>
                                </li>
                                <li>
                                    <a data-nav href="mailto:orcadentallab@gmail.com" className="flex items-start gap-3 group hover:text-white transition-colors duration-200">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm">
                                <li><a data-nav href="/login" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">Doctor Login</a></li>
                                <li><a data-nav href="/login" className="hover:text-white hover:translate-x-1 inline-block transition-[color,transform] duration-200">Register Clinic</a></li>
                            </ul>
                            <div className="mt-6">
                                <a data-nav href="#contact" className="inline-flex items-center gap-2 bg-brand-blue/20 hover:bg-brand-blue text-brand-sky hover:text-white px-5 py-2.5 rounded-full text-sm font-bold transition-colors duration-300">
                                    Start a Case →
                                </a>
                            </div>
                        </div>
